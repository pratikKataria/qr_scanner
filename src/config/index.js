module.exports = {
    ...
    host: process.env.HOST || '0.0.0.0', // Must bind to 0.0.0.0 to allow external access without Nginx
    appNamespace: process.env.APP_NAMESPACE || 'com.swc.sunni_aiemma_council',
    customScheme: 'sunnicouncil', // The custom scheme for the mobile app
